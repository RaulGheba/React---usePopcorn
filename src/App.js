...
function MovieDetails({ selectedId, onCloseMovie, onAddWatched, watched }) {
  ...
  useEffect(
    ...
    [title]
  ); // this changes the title of the page because title changes in the component, whatever it is. therefore, the dependency array dictates that this effect should run again.
